...
@NamedQueries({
    ...
    , @NamedQuery(name = "Cellphone.findByMerchandiseID", query = "SELECT c FROM Cellphone c WHERE c.merchandiseID = :merchandiseID")})
public class Cellphone implements Serializable {
    ...
    public Cellphone(Integer merchandiseID) {
    ...
    public String toString() {
        return "entities.Cellphone[ merchandiseID=" + merchandiseID + " ]";
    }
