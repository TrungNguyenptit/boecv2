...
@NamedQueries({
    ...
    , @NamedQuery(name = "Laptop.findByMerchandiseID", query = "SELECT l FROM Laptop l WHERE l.merchandiseID = :merchandiseID")})
public class Laptop implements Serializable {
    ...
    public Laptop(Integer merchandiseID) {
    ...
    public String toString() {
        return "entities.Laptop[ merchandiseID=" + merchandiseID + " ]";
    }
